...
import type { Application, ApplicationAttachment, ApplicationWorkflowMessage } from '@/entities/application/model/types'
...
import { fullHeightPageStyle, PAGE_CONTENT_PADDING } from '@/shared/lib/page-layout'
import {
...
import { ApplicationWorkflowFinalizeModal } from '@/features/application-workflow/ui/ApplicationWorkflowFinalizeModal'
...
export function ApplicationWorkflowPage() {
  ...
  }, [applicationId, handleBack, notification, t])
  ...
  const viewerUnitStatus = useMemo(
    () =>
      workflowTarget
        ...
        : undefined,
    [workflowTarget, currentUser?.structuralUnitId],
  )
  ...
  if (!applicationId) {
    return <Empty description={t('applicationWorkflow.notFound')} />
  }
  ...
  return (
    <div style={pageShellStyle}>
      ...
      {!isFinalized ? (
        <WorkflowChatComposer onSend={handleSend} sending={sending} />
      ) : null}
